...
from models import UserDB, ChangePasswordRequest
...
def search_user_by_id(id: str) -> UserDB:
    ...
    if not ObjectId.is_valid(id):
        raise HTTPException(status_code=400, detail=f"Invalid user ID: {id}")
...
def change_user_password(user_id: str, data: ChangePasswordRequest) -> str:
    """Cambia la contrasña de un usuario"""
    ...
    update_user_db(user_id, {"password_hash": new_hash})
